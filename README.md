...
Hangfire OPC Labs v1.x solution that contains a standard .NET 4.8 MVC project by which the OPC UA server and clients are managed. It includes two projects, a console application for tests and a Windows service project.
